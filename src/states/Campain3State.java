...
public class Campain3State extends BasicGameState {
	...
	public void init(GameContainer arg0, StateBasedGame arg1)
		...
		this.addEnemyTimer(temp, 0);
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), FakeGameContainer.getInstance().getHeight()/2, -250, 0, 100, 100, 300, 300, image, false, 1, false, 1000);
		...
		this.addEnemyTimer(temp, 0);
		temp = new EnemyIA(types.RAFALEVISEE);
		this.addEnemyTimer(temp, 200);
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), 0, -220, 220, 100, 105, 300, 300, image, false, 1, false, 1000);
		this.addEnemyTimer(temp, 0);
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), FakeGameContainer.getInstance().getHeight(), -220, -220, 100, 105, 300, 300, image, false, 1, false, 1000); 
		this.addEnemyTimer(temp, 2000);
		...
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), FakeGameContainer.getInstance().getHeight(), -220, -110, 100, 100, 300, 300, image, false, 1, false, 1000);
		this.addEnemyTimer(temp, 0);
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), 0, -220, 110, 100, 100, 300, 300, image, false, 1, false, 1000);
		this.addEnemyTimer(temp, 200);
		...
		this.addEnemyTimer(temp, 0);
		temp = new Enemy(FakeGameContainer.getInstance().getWidth(), FakeGameContainer.getInstance().getHeight()*3/4, -220, 0, 100, 100, 300, 300, image, false, 1, false, 1000); 
		this.addEnemyTimer(temp, 200);
		temp = new EnemyIA(types.VISEJOUEUR);
		this.addEnemyTimer(temp, 0);
		temp = new EnemyIA(types.VISEJOUEUR);
		...
		this.addEnemyTimer(temp, 0);
		temp = new EnemyIA(types.RAFALEVISEE);
		this.addEnemyTimer(temp, 8000);
		//On construit la partie
		temp = new EnemyIA(types.Coreen);
		this.addEnemyTimer(temp, 1500);
	...
	public void render(GameContainer container, StateBasedGame sbg, Graphics g)
		...
		if(this.onBoss){
			int numberOfLines = (int) (this.boss.getLife() * 2.5);
